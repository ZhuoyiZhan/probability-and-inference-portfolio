...
We can see that one can either lose or win with Martingale strategy. Matigale is not 100% winning.
...
g1
```
During 1000 games, The Roulette player either win $300 or lose all money.
...
mean(walk_out_money - 200)
```
The probability that player would win $300 is 51.37% and the average earining for Roulette is -45.8854. So Matingale Startegy is not profitable.
