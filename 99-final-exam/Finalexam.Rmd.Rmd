...
## conditional distribution has smaller variance so smaller average prediction error. conditional givesprobabilities contingent upon the values of the other variables. by summing values in a table along rows or columns
